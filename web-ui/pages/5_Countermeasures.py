...
def main():
    ...
    with tab1:
        ...
        layout = go.Layout(
            ...
            title={"text": 'Cumulative Injections Administered (December 2020 - April 2024)'},
        ...
        st.markdown("---")
        st.caption("Data published up to and including 27th April 2024.")
        st.caption(
            """
        Data sourced from 
