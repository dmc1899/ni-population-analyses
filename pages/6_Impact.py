...
st.title('Impact of Countermeasures')
...
with tab2:
    df_pip_and_injections = load_data('data/MonthlyDisabilityRegistrationsAndInjectionsNov2022.pkl')
    ...
    # Add figure title
    fig.update_layout(
        title_text="Cumulative Injections and Personal Independence Payment Claims by Month (2016-2022 Nov)",
        height=650
    )
