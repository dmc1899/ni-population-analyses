...
@st.cache_data
def load_data():
    dataframe = pd.read_pickle('data/deaths/AllDeathsUpTo2023Week14.pkl')
    return dataframe
...
with st.sidebar:
    ...
    analysis_end_week_selected = st.number_input('2023 Registration Week:', min_value=1, max_value=14, step=1, value=14,
